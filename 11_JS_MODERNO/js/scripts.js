...
const products = [
  ...
  { name: "Calsa Jeans", price: 87.99, category: "Roupas" },
];
...
console.log(`Nome do usuáio é ${Username} e ele tem ${age} anos`);
...
console.log(
  `O mome do produto é ${productName}, ele custa R$${price} e é da cor ${color}`
);
